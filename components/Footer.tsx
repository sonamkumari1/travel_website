  ...
  <FooterColumn key={columns.title} title={columns.title}>
    <ul className="text-[14px] font-[400] flex flex-col gap-4 text-gray-30">
      {columns.links.map((link) => (
          ...
          {link}
            ...
            <div className="flex flex-col gap-5">
              <FooterColumn title={SOCIALS.title}>
                <ul className="text-[14px] font-[400] flex gap-4 text-gray-300">
        ...
        <p className="text-[14px] font-[400] w-full text-center text-gray-300">2023 Hilink | All rights reserved</p>
      </div>
    </footer>
  )
}
